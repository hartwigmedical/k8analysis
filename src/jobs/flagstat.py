...
class FlagstatJob(JobABC):
    input_path: GCPPath
    output_path: GCPPath

    @classmethod
    def get_job_type(cls) -> JobType:
        return JobType.FLAGSTAT
    ...
    def execute(self, service_provider: ServiceProviderABC) -> None:
        ...
        logging.info("Starting flagstat")
        bash_tool_box.flagstat(local_input_path, local_output_path)
        logging.info("Finished flagstat")
